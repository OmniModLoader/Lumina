 ...
 * <p>
 * Implementing classes will provide their own implementation of the {@linkplain IParser#run(String, ParsingContainer)} method to process
 * a given line and update the {@linkplain ParsingContainer} accordingly.
 *
 *
